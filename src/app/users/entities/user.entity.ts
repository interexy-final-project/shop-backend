import {Cascade, Entity, Enum, ManyToOne, OneToMany, Property,} from '@mikro-orm/core';
...
export class UserEntity extends UUIDEntity {
  ...
  @Enum({ name: 'status', array: false, items: () => EUserStatuses, default: EUserStatuses.ACTIVE })
