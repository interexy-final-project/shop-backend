...
export class Migration20230824170421 extends Migration {
  ...
  async down(): Promise<void> {
    ...
    this.addSql('create table "categories" ("id" bigserial primary key, "created" timestamptz not null default null, "updated" timestamptz not null default null, "name" text not null default null);');
    this.addSql('alter table "categories" add constraint "categories_name_unique" unique ("name");');

    this.addSql('create table "kinds" ("id" bigserial primary key, "created" timestamptz not null default null, "updated" timestamptz not null default null, "name" text not null default null, "type_id" int8 null default null);');
    this.addSql('alter table "kinds" add constraint "kinds_name_unique" unique ("name");');

    this.addSql('create table "types" ("id" bigserial primary key, "created" timestamptz not null default null, "updated" timestamptz not null default null, "name" text not null default null, "category_id" int8 null default null);');
