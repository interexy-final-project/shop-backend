...
export class Migration20230903202729 extends Migration {
  async up(): Promise<void> {
    ...
    this.addSql(
      'create table "users" ("id" uuid not null, "created" timestamptz(0) not null, "updated" timestamptz(0) not null, "first_name" varchar(255) null, "second_name" varchar(255) null, "email" varchar(255) not null, "password" varchar(255) not null, "rt_hash" text null, "status" text check ("status" in (\'Active\', \'Archived\')) not null default \'Active\', "role_id" uuid null, constraint "users_pkey" primary key ("id"));',
    );
    this.addSql(
